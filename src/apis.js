...
const doGet = async (route, headers, params) => {
  try {
    return (await axios({
      ...
      headers: { ...defaultHeaders, ...headers, Authorization: window.localStorage.getItem('token') },
    })).data.data;
  }
  catch (e) {
    throw e;
...
export const apiDeleteSchool = async (idSchool) => {
  try {
    ...
    showMessage(`Delete school error: ${e.response.data || e.message}`, 'error');
  }
  return false;
}
...
export const apiNewSchool = async (school) => {
  try {
    ...
    showMessage(`Error creating new school: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiGetClassGroups = async () => {
  try {
    ...
    showMessage(`Error getting class groups: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiGetClasses = async (params) => {
  try {
    ...
    showMessage(`Error getting classes of school ${params.school_id}: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiNewClass = async (klass) => {
  try {
    ...
    showMessage(`Error creating new class: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiNewPupil = async (pupil) => {
  try {
    ...
    showMessage(`Error creating new pupil: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiGetSubjectGroups = async (params) => {
  try {
    ...
    showMessage(`Error getting subject groups: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiGetSubjects = async (params) => {
  try {
    ...
    showMessage(`Error getting subjects of school ${params.school_id}: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiNewSubject = async (subject) => {
  try {
    ...
    showMessage(`Error creating new subject: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiDeleteSubject = async (idSubject) => {
  try {
    ...
    showMessage(`Delete subject error: ${e.response.data || e.message}`, 'error');
  }
  return false;
}
...
export const apiNewLab = async (lab) => {
  try {
    ...
    showMessage(`Error creating new lab: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiGetUserInfo = async () => {
  try {
    ...
    showMessage(`Error getting user info: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiUpdateUser = async (payload) => {
  try {
    ...
    showMessage(`Error updating user: ${e.response.data || e.message}`, 'error');
  }
}
...
export const uploadImage = async (file) => {
  ...
  try {
    ...
    showMessage(`Error uploading image: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiUploadLab = async (file, data) => {
  ...
  try {
    ...
    showMessage(`Error uploading lab asset: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiImportXlsx = async (file, data, type) => {
  ...
  try {
    ...
    showMessage(`Error importing students: ${e.response.data || e.message}`, 'error');
  }
}
...
export const apiExportXlsx = async (type, payload) => {
  ...
  try {
    ...
    showMessage(`Error exporting students: ${e.response?.data || e.message}`, 'error');
  }
}
